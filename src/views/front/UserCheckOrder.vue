  ...
  <section class="mb-5">
    <div class="container">
      ...
      <div class="d-flex justify-content-center align-items-center mb-5 mt-3">
        ...
        <h6 class="d-flex flex-column text-center fw-bold mb-0 text-secondary pay-header" :class="{'active': order.is_paid === false}">
          <span class="mb-1">STEP 2</span>
          <span>Payment</span>
        </h6>
        <i class="bi bi-caret-right-fill mx-1 mx-md-2 text-secondary"></i>
        <h6 class="d-flex flex-column text-center fw-bold mb-0 text-secondary pay-header" :class="{'active': order.is_paid === true}">
          <span class="mb-1">STEP 3</span>
          <span>Complete</span>
        </h6>
      </div>
      <!-- <div class="d-flex justify-content-center align-items-center mb-5 mt-3">
        <h6 class="fw-bold mb-0 text-secondary pay-header">Information</h6>
        <i class="bi bi-caret-right-fill mx-1 mx-md-2 text-secondary"></i>
        <h6 class="fw-bold mb-0 text-secondary pay-header" :class="{'active': order.is_paid === false}">Payment</h6>
        <i class="bi bi-caret-right-fill mx-1 mx-md-2 text-secondary"></i>
        <h6 class="fw-bold mb-0 text-secondary pay-header" :class="{'active': order.is_paid === true}">Complete</h6>
      </div> -->
            ...
            <form class="col-lg-6" @submit.prevent="payOrder">
              ...
              <table class="table table-light table-borderless mb-4">
                ...
                <tr class="table-nowrap">
                  ...
                  <td>
                    <span v-if="!order.is_paid" class="text-nowrap text-danger fw-bold">Not Yet Paid</span>
              ...
              <div class="text-end" v-if="order.is_paid === false">
                <button class="btn btn-primary ms-auto rounded-0" type="submit">Confirm Payment<i class="bi bi-caret-right-fill"></i></button>
              </div>
              <div class="text-end" v-if="order.is_paid === true">
                <RouterLink to="/products" class="btn btn-primary ms-auto rounded-0"><i class="bi bi-cart4 pe-1 fs-5"></i>Continue Shopping</RouterLink>
              </div>
            </form>
          </div>
        </div>
