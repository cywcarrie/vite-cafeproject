              ...
              <div class="p-3 bg-white">
                <div v-if="cart.final_total > 0">
                  <p class="py-3 text-center border-bottom border-primary">
                    <span class="fw-bold">{{ cart.carts.length }}</span> item(s)</p>
                  ...
                  <RouterLink to="/cart"
                    class="py-2 btn btn-primary text-center rounded-0 w-100 fw-bold text-uppercase">checkout</RouterLink>
                </div>
                <div v-else>
                  <p class="py-3 text-center">There are no items in your cart.</p>
                  <RouterLink to="/products" class="py-2 btn btn-primary text-center rounded-0 w-100 fw-bold">Shop Now!</RouterLink>
                </div>
              </div>
            </ul>
          </div>
